...
namespace UIWidgets
{
    ...
    /// </summary>
    [Serializable]
    public class ListViewItemChanged : UnityEvent<string, GameObject>
    {
		...
		IMoveHandler, IComparable<ListViewItem>
	{
        ...
        public ListViewItemChanged onChanged = new ListViewItemChanged();
//        public ListViewItemSelect onChanged = new ListViewItemSelect();
        public virtual void OnChanged(string eventName, GameObject target)
        {
            onChanged.Invoke(eventName , target);
        }
