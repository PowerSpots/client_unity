...
namespace UIWidgets
{
	...
	public class ComboboxIcons : ComboboxCustom<ListViewIcons,ListViewIconsItemComponent,ListViewIconsItemDescription>
	{
		...
		#if UNITY_EDITOR
		[UnityEditor.MenuItem("GameObject/UI/New UI Widgets/ComboboxIcons", false, 1040)]
		static void CreateObject()
		{
			Utilites.CreateWidgetFromAsset("ComboboxIcons");
		}

		[UnityEditor.MenuItem("GameObject/UI/New UI Widgets/ComboboxIconsMultiselect", false, 1041)]
