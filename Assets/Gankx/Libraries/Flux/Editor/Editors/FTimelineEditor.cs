...
//		}
		...
		private void ShowAddTrackMenu()
		{
			...
			if( fluxAssembly != System.Reflection.Assembly.GetExecutingAssembly() )
			{
				// if we are in the flux trial, basically allow to get the types in the project assembly
				ArrayUtility.AddRange<Type>( ref types, System.Reflection.Assembly.GetExecutingAssembly().GetTypes() );
			}
