...
//		None 				= 0,
	...
	public class FTrack : FObject
	{
		...
		[SerializeField]
		[HideInInspector]
		private bool _alwaysUseCache = false;
		public bool AlwaysUseCache { get { return _alwaysUseCache; } }

//		public virtual bool RequiresEditorCache() { return false; }
//		public virtual bool RequiresRuntimeCache() { return false; }
...
//		public virtual FTrackCacheType DefaultCacheType(){ return FTrackCacheType.None; }
...
//			track.SetId( id );
		...
		public int GetEventsAt( int t, ref FEvent[] evtBuffer )
		{
			...
			for( int i = 0; i != _events.Count; ++i )
			{
				FEvent evt = _events [i];
				if (evt.Start <= t && evt.End >= t)
					evtBuffer.SetValue (evt, index++);
				else if( evt.Start > t ) // since they are ordered, no point in continuing
					break;
			}
...
//				Init();
		...
		public virtual bool PreviewDirtiesScene { get { return false; } }

		/** @brief Can the preview of the scene be toggled off? */
		public virtual bool CanTogglePreview { get { return false; } }
