...
namespace AmplifyColor
{
	public class LUTEditor : EditorWindow
	{
		...
		private void ShowReadBackBufferGUI()
		{
			...
			Settings.AddLut = true; // EditorGUILayout.Toggle( "Add LUT", Settings.AddLut );
			Settings.ApplyHDRControl = false; // EditorGUILayout.Toggle( "Apply HDR Control", Settings.ApplyHDRControl );
			Settings.ApplyColorGrading = false; // EditorGUILayout.Toggle( "Apply Color Grading", Settings.ApplyColorGrading );
