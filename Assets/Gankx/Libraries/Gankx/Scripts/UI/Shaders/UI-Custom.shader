...
Shader "UI/Custom"
{
	Properties
	{
		...
		[Toggle(UI_SOFT_CLIP)] _SoftClip("SoftClip", Float) = 0
		_ClipSoft("ClipSoft", Vector) = (0,0,0,0)


		[Toggle(UNITY_UI_ALPHACLIP)] _UseUIAlphaClip ("Use Alpha Clip", Float) = 0

		[Toggle(UI_SOFT_GRAY)] _UseUIGray("Use Gray", Float) = 0
	}
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#pragma multi_compile __ UI_SOFT_GRAY
