...
namespace Gankx.UI
{
    ...
    /// </summary>
    public abstract class Tweener : MonoBehaviour, IPoolable
    {
        /// <summary>
        ///   <para>Finished Event type used by the Tweener.</para>
        /// </summary>
        [Serializable]
        public class TweenerFinishedEvent : UnityEvent
        {
        }
        ...
        /// </summary>
        [HideInInspector]
        public TweenerFinishedEvent onFinished = new TweenerFinishedEvent();
		...
		if ((object)comp == null) comp = (T)go.AddComponent<T>();
            ...
            if (comp == null)
            {
                ...
                if (comp == null)
                {
                    Debug.LogError("Unable to add " + typeof(T) + " to " + UITools.GetHierarchy(go), go);
                    return null;
                }
            }
#endif
        ...
        private bool defaultEnable = false;
        public void OnSpawn()
        {
