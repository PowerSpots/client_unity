...
namespace Gankx.UI
{
    ...
    /// </summary>
    [ExecuteInEditMode]
    [AddComponentMenu("UI/Interaction/Play Animation")]
    public class PlayAnimation : MonoBehaviour
    {
        public static PlayAnimation current = null;
...
#if UNITY_EDITOR
                if (animator != null) UITools.SetDirty(this);
#endif
            }
...
#if UNITY_EDITOR
                if (target != null) UITools.SetDirty(this);
#endif
            }
