...
local function unloadUnusedAssets(async)
    ...
    if async ~= nil and asyncOperation ~= nil then
...
function startup(self)
    Console.info("GalaxyGame startup")
    ...
    local start_scope = SystemScope.Login
    SystemService.instance:switchScope(start_scope)
    self._curScope = start_scope
